...
static const struct led_effect led_system_state_effect[LED_SYSTEM_STATE_COUNT] = {
	[LED_SYSTEM_STATE_IDLE] = LED_EFFECT_LED_ON(LED_NOCOLOR()),
	[LED_SYSTEM_STATE_CHARGING] = LED_EFFECT_LED_ON(LIGHTBLUE),
	[LED_SYSTEM_STATE_NO_CHARGING] = LED_EFFECT_LED_ON(LED_NOCOLOR()),
	[LED_SYSTEM_STATE_NEED_CHARGING] = LED_EFFECT_LED_BREATH(500, ORANGE),
...
static const struct led_effect led_peer_state_effect[LED_PEER_COUNT][LED_PEER_STATE_COUNT] = {
	{
		...
		[LED_PEER_STATE_CONNECTED] = LED_EFFECT_LED_ON(GREEN),
		[LED_PEER_STATE_PEER_SEARCH] = LED_EFFECT_LED_BLINK(1000, LIGHTBLUE),
	...
	},
	{
		[LED_PEER_STATE_DISCONNECTED] = LED_EFFECT_LED_OFF(),
		[LED_PEER_STATE_CONNECTED] = LED_EFFECT_LED_ON(GREEN),
		[LED_PEER_STATE_PEER_SEARCH] = LED_EFFECT_LED_BLINK(200, YELLOW),
