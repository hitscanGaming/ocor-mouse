 ...
 */
const struct {
} led_state_def_include_once;

// Complement RGB
#define BLACK	  LED_COLOR(0, 0, 0)
#define RED	  LED_COLOR(255, 0, 0)
#define GREEN	  LED_COLOR(0, 255, 0)
#define BLUE	  LED_COLOR(0, 0, 255)
#define LIGHTBLUE LED_COLOR(0, 100, 100)
#define YELLOW	  LED_COLOR(255, 255, 0)
#define ORANGE	  LED_COLOR(255, 160, 0)
#define PURPLE	  LED_COLOR(127, 0, 255)
#define CYAN	  LED_COLOR(0, 255, 255)
#define WHITE	  LED_COLOR(255, 255, 255)

/* Map function to LED ID */
static const uint8_t led_map[LED_ID_COUNT] = {[LED_ID_SYSTEM_STATE] = 0, [LED_ID_PEER_STATE] = 0};
...
static const struct led_effect led_peer_state_effect[LED_PEER_COUNT][LED_PEER_STATE_COUNT] = {
	{
		...
		[LED_PEER_STATE_CONNECTED] = LED_EFFECT_LED_ON(WHITE),
		[LED_PEER_STATE_PEER_SEARCH] = LED_EFFECT_LED_BLINK(1000, WHITE),
