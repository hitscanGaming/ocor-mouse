 ...
 * @{
 */
#define REPORT_ID_SIZE 1 /* bytes */

/** Dual Mouse Report (Aggregated) */
...
static const uint8_t input_reports[] = {
	REPORT_ID_MOUSE,	 REPORT_ID_KEYBOARD_KEYS, REPORT_ID_SYSTEM_CTRL,
	REPORT_ID_CONSUMER_CTRL, REPORT_ID_BOOT_MOUSE,	  REPORT_ID_BOOT_KEYBOARD,
};
