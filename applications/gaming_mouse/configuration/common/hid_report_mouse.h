...
#define MOUSE_REPORT_XY_MIN	      (-32768)
...
#define REPORT_MAP_MOUSE(report_id)                                                                \
	...
	0x09, 0x01,	    /* Usage (Pointer) */                                                  \
		...
		0x85, report_id, /* Report ID */                                                   \
                                                                                                   \
		0x05, USAGE_PAGE_MOUSE_BUTTONS, 0x19, 0x01, /* Usage Minimum (1) */                \
		...
		0x81, 0x02,				    /* Input (Data, Variable, Absolute) */ \
                                                                                                   \
		0x05, USAGE_PAGE_MOUSE_WHEEL, 0x09, 0x38, /* Usage (Wheel) */                      \
		...
		0x81, 0x06,				  /* Input (Data, Variable, Relative) */   \
                                                                                                   \
		0x05, USAGE_PAGE_MOUSE_XY, 0x09, 0x30, /* Usage (X) */                             \
		0x09, 0x31,			       /* Usage (Y) */                             \
		0x16, 0x00, 0x80,		       /* Logical Maximum (2047) */                \
		0x26, 0xFF, 0x7F,		       /* Logical Minimum (-2047) */               \
