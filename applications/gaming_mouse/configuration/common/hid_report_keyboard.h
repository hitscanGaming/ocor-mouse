...
#define REPORT_MASK_KEYBOARD_KEYS                                                                  \
	{                                                                                          \
...
#define REPORT_MAP_KEYBOARD(report_id_keys, report_id_leds)                                        \
	...
	0x85, report_id_keys,                                                                      \
                                                                                                   \
		/* Keyboard - Modifiers */                                                         \
		0x05, USAGE_PAGE_KEYBOARD, 0x19,                                                   \
		KEYBOARD_REPORT_FIRST_MODIFIER,	     /* Usage Minimum */                           \
		...
		0x81, 0x01, /* Input (Constant) */                                                 \
                                                                                                   \
		/* Keyboard - Keys */                                                              \
		0x05, USAGE_PAGE_KEYBOARD, 0x19, 0x00, /* Usage Minimum (0) */                     \
		...
		0x85, report_id_leds,                                                              \
                                                                                                   \
		/* Keyboard - LEDs */                                                              \
		0x05, USAGE_PAGE_LEDS, 0x19, 0x01, /* Usage Minimum (1) */                         \
