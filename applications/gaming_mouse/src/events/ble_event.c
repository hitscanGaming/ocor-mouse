...
APP_EVENT_TYPE_DEFINE(
	ble_discovery_complete_event, NULL, NULL,
	APP_EVENT_FLAGS_CREATE(IF_ENABLED(CONFIG_DESKTOP_INIT_LOG_BLE_DISC_COMPLETE_EVENT,
...
APP_EVENT_TYPE_DEFINE(ble_qos_event, log_ble_qos_event, NULL,
		      APP_EVENT_FLAGS_CREATE(IF_ENABLED(CONFIG_DESKTOP_INIT_LOG_BLE_QOS_EVENT,
							(APP_EVENT_TYPE_FLAGS_INIT_LOG_ENABLE))));
#endif
