 ...
 */
void chmap_filter_crc_update(struct chmap_instance *p_inst, uint8_t ch_idx, uint16_t crc_ok,
			     uint8_t crc_error);
 ...
 */
int chmap_filter_chn_info_get(struct chmap_instance *p_inst, uint8_t chn_idx, uint8_t *p_state,
			      int16_t *p_rating, uint8_t *p_freq);
