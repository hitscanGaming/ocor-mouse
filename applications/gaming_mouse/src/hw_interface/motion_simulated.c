...
const static struct vertex coords[] = {
	{-50 * SCALE, 0}, {-35 * SCALE, -35 * SCALE}, {0, -50 * SCALE}, {35 * SCALE, -35 * SCALE},
	{50 * SCALE, 0},  {35 * SCALE, 35 * SCALE},   {0, 50 * SCALE},	{-35 * SCALE, 35 * SCALE},
};
...
{
	BUILD_ASSERT((edge_time & (edge_time - 1)) == 0, "Edge time must be power of 2");
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_motion_sim, SHELL_CMD(start, NULL, "Start motion", start_motion),
