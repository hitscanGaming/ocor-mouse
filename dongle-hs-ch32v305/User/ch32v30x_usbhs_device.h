...
/* HID Class Command */
extern volatile uint8_t  USBHS_HidIdle[ 3 ];
extern volatile uint8_t  USBHS_HidProtocol[ 3 ];

/* User Config Data (Added) */
extern volatile uint8_t  UserConfigData[ FEATURE_REPORT_SIZE ];
extern volatile uint8_t  UserConfigReceived;
...
extern volatile uint32_t g_usb_packet_count;
